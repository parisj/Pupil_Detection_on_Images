...
def evaluate(points, params, threshold, area, best_area, best_inliers,best_border, best_ellipse):
    ...
    for point in points:
        #dist = signed_distance_to_ellipse(point[0],point[1],a,b,xc,yc,angle)
        dist= distance_to_ellipse_eigen(point[0],point[1],a,b,xc,yc,angle)
