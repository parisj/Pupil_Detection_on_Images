...
border_size = 10  # Define the size of the border
x1, y1 = pupil_center[0] - border_size, pupil_center[1] - border_size
x2, y2 = pupil_center[0] + border_size, pupil_center[1] + border_size
green_color = (0, 255, 0)
line_thickness = 2
cv2.rectangle(eye_image, (x1, y1), (x2, y2), green_color, line_thickness)
